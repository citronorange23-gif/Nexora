  ...
  const MODULES: ModuleConfig[] = [
    ...
    },
    {
      ...
      label: "Produits",
      description:
        "Gérez vos produits, leurs prix et leurs informations.",
      icon: "🏷️",
    ...
    },
    {
      ...
      label: "Assistant IA",
      description:
        "Obtenez de l'aide pour gérer votre entreprise.",
      icon: "✨",
      href: "/dashboard/ai",
      showAddButton: false,
    },
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                  {visibleModules.map((module) => {
                    ...
                    return (
                      <Card
                        key={module.key}
                        className="group p-5 transition hover:-translate-y-0.5 hover:border-slate-700 hover:bg-slate-900/80"
                        href={module.href}
                        showAddButton={module.showAddButton}
                        addButtonText="Ajouter"
                        addButtonHref={`${module.href}/new`}
                      >
